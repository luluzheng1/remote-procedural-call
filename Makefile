...
CPPFLAGS = -g -Wall -Werror -I$(C150IDSRPC) -I$(C150LIB) -std=c++2a -std=c++11
...
all: idldeclarationtst idl_to_json lotsofstuffclient lotsofstuffserver

# pingstreamclient pingstreamserver  simplefunctionclient simplefunctionserver 
########################################################################
#
...
clean:
	 rm -f pingstreamclient pingstreamserver idldeclarationtst simplefunctionclient simplefunctionserver *.o *.json *.pyc *proxy.cpp *stub.cpp GRADELOG* *debug.txt
